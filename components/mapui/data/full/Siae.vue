<template>
  <div class="mb-16 p-2">
    <div class="mb-6 px-5">
      <h1 class="mb-2 text-2xl font-bold">{{ element.enseigne }}</h1>
      <h3>
        {{ element.addresse_ligne_1 }}, {{ element.ville }}
        {{ element.code_postal }}
      </h3>
      <div class="flex justify-between py-4">
        <p v-if="element.mis_a_jour_le" class="my-auto">
          Mis à jour le {{ element.mis_a_jour_le.split('T')[0] }}
        </p>
        <a
          v-if="element.site_web"
